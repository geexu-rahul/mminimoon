                        ...
                        @if($result->host_fee)
                            <div class="d-flex justify-content-between text-16">
                                <div>
                                    ...
                                    <i class="icon icon-question icon-question-sign" data-behavior="tooltip" rel="tooltip" aria-label="Minimoon charges a fee to cover the cost (banking fees) of processing payment from the traveler."></i>
