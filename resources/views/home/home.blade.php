							...
							<form id="front-search-form" method="post" action="{{url('search')}}">
								...
								<div class="row">
									<div class="col-md-12">
										...
										<div class="d-flex" autocomplete="off" action="/action_page.php">
...
<script type="text/javascript">
    var simple = '<?php echo $starting_cities; ?>';
    var complex = <?php echo json_encode($starting_cities); ?>;


	var allcities =  complex.map(item => {
		return item.name;
	})
                                            ...
                                            <div class="">
                                                @auth
                                                    <a class="btn btn-sm book_mark_change"
                                                       ...
                                                       style="color:{{($property->book_mark == true) ? '#2248ab':''}}; ">
